package com.oasis;/*
    ...
    This is a atm project developed to perform following operations 
    1)Register as a new user
    2)Login as a registered user
    3)Checking balance amount
    4)Withdrawing amount from account
    5)Transferring funds from one account to another account
